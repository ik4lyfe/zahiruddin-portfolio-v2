        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-12 pb-20 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative order-2 md:order-1">
            <div className="grid grid-cols-3 gap-3">
              <img src={photos[0]} alt="work" className="hero-img col-span-2 aspect-[4/3] object-cover rounded-sm relative z-30" />
              <img src={photos[1]} alt="work" className="hero-img aspect-[4/3] object-cover rounded-sm mt-8" />
              <img src={photos[2]} alt="work" className="hero-img aspect-[3/4] object-cover object-[65%_65%] scale-110 rounded-sm -mt-20 ml-8 relative z-20" />
